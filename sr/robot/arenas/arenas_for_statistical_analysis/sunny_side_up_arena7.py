...
class SunnySideUpArena(Arena):
	...
	for i in range(38):
        ...
        token.location = (-8.2, -3.1)
        self.objects.append(token) 
        count+1
        
        token=SilverToken(self,count)
        token.location = (-4.2, 3.8)
        self.objects.append(token) 
        count+1
        
        token=SilverToken(self,count)
        token.location = (-2.3, 2.8)
        self.objects.append(token) 
        count+1
        
        token=SilverToken(self,count)
        token.location = (1.5, -0.3)
        self.objects.append(token) 
        count+1
        
        token=SilverToken(self,count)
        token.location = (3.6, 3.6)
        self.objects.append(token) 
        count+1
        
        token=SilverToken(self,count)
        token.location = (8.1, 2.7)
        self.objects.append(token) 
        count+1
        
        token=SilverToken(self,count)
        token.location = (2.2, -4.3)
        self.objects.append(token) 
        count+1
