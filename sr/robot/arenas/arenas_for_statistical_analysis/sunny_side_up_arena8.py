...
class SunnySideUpArena(Arena):
	...
	for i in range(38):
        ...
        token.location = (-7.6, -1.3)
        self.objects.append(token) 
        count+1
        
        token=SilverToken(self,count)
        token.location = (-6.1, 3.75)
        self.objects.append(token) 
        count+1
        
        token=SilverToken(self,count)
        token.location = (-2.3, 1)
        self.objects.append(token) 
        count+1
        
        token=SilverToken(self,count)
        token.location = (1.3, 0)
        self.objects.append(token) 
        count+1
        
        token=SilverToken(self,count)
        token.location = (5.1, 3.9)
        self.objects.append(token) 
        count+1
        
        token=SilverToken(self,count)
        token.location = (8.2, 0.5)
        self.objects.append(token) 
        count+1
        
        token=SilverToken(self,count)
        token.location = (-2.4, -4.2)
        self.objects.append(token) 
        count+1
