...
class SunnySideUpArena(Arena):
	...
	for i in range(38):
        ...
        token.location = (-7.4, 2.5)
        self.objects.append(token) 
        count+1
        
        token=SilverToken(self,count)
        token.location = (-7.6, 4.1)
        self.objects.append(token) 
        count+1
        
        token=SilverToken(self,count)
        token.location = (-2.3, 0.4)
        self.objects.append(token) 
        count+1
        
        token=SilverToken(self,count)
        token.location = (2.0, 0.3)
        self.objects.append(token) 
        count+1
        
        token=SilverToken(self,count)
        token.location = (6.2, 3.7)
        self.objects.append(token) 
        count+1
        
        token=SilverToken(self,count)
        token.location = (7.5, -3)
        self.objects.append(token) 
        count+1
        
        token=SilverToken(self,count)
        token.location = (-3.8, 4)
        self.objects.append(token) 
        count+1
