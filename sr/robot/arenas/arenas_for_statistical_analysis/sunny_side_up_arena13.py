...
class SunnySideUpArena(Arena):
	...
	for i in range(38):
        ...
        token.location = (-7.4, -2.8)
        self.objects.append(token) 
        count+1
        
        token=SilverToken(self,count)
        token.location = (-6.1, 3.9)
        self.objects.append(token) 
        count+1
        
        token=SilverToken(self,count)
        token.location = (-2.6, 2.1)
        self.objects.append(token) 
        count+1
        
        token=SilverToken(self,count)
        token.location = (0.3, -0.6)
        self.objects.append(token) 
        count+1
        
        token=SilverToken(self,count)
        token.location = (5.6, 3.8)
        self.objects.append(token) 
        count+1
        
        token=SilverToken(self,count)
        token.location = (8.2, 2.4)
        self.objects.append(token) 
        count+1
        
        token=SilverToken(self,count)
        token.location = (1.2, -4.9)
        self.objects.append(token) 
        count+1
