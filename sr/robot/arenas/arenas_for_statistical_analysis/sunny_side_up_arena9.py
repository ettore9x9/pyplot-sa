...
class SunnySideUpArena(Arena):
	...
	for i in range(38):
        ...
        token.location = (-8.1, 1.5)
        self.objects.append(token) 
        count+1
        
        token=SilverToken(self,count)
        token.location = (-6.8, 3.3)
        self.objects.append(token) 
        count+1
        
        token=SilverToken(self,count)
        token.location = (-2.7, 2.4)
        self.objects.append(token) 
        count+1
        
        token=SilverToken(self,count)
        token.location = (1.4, -0.3)
        self.objects.append(token) 
        count+1
        
        token=SilverToken(self,count)
        token.location = (3.2, 3.3)
        self.objects.append(token) 
        count+1
        
        token=SilverToken(self,count)
        token.location = (8.1, 2.4)
        self.objects.append(token) 
        count+1
        
        token=SilverToken(self,count)
        token.location = (-3.4, -4.1)
        self.objects.append(token) 
        count+1
