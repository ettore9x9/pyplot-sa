...
class SunnySideUpArena(Arena):
	...
	for i in range(38):
        ...
        token.location = (-8.2, -1.4)
        self.objects.append(token) 
        count+1
        
        token=SilverToken(self,count)
        token.location = (-3.4, 3.6)
        self.objects.append(token) 
        count+1
        
        token=SilverToken(self,count)
        token.location = (-2.3, 1.4)
        self.objects.append(token) 
        count+1
        
        token=SilverToken(self,count)
        token.location = (1.8, -0.1)
        self.objects.append(token) 
        count+1
        
        token=SilverToken(self,count)
        token.location = (5.2, 3.8)
        self.objects.append(token) 
        count+1
        
        token=SilverToken(self,count)
        token.location = (7.6, -2.9)
        self.objects.append(token) 
        count+1
        
        token=SilverToken(self,count)
        token.location = (1.7, -3.8)
        self.objects.append(token) 
        count+1
