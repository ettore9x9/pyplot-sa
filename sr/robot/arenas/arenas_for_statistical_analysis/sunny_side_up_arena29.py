...
class SunnySideUpArena(Arena):
	...
	for i in range(38):
        ...
        token.location = (-7.7, 0.8)
        self.objects.append(token) 
        count+1
        
        token=SilverToken(self,count)
        token.location = (-7.9, 4.2)
        self.objects.append(token) 
        count+1
        
        token=SilverToken(self,count)
        token.location = (-2.8, 0.2)
        self.objects.append(token) 
        count+1
        
        token=SilverToken(self,count)
        token.location = (-0.3, 0.1)
        self.objects.append(token) 
        count+1
        
        token=SilverToken(self,count)
        token.location = (6.2, 3.9)
        self.objects.append(token) 
        count+1
        
        token=SilverToken(self,count)
        token.location = (7.8, -3.1)
        self.objects.append(token) 
        count+1
        
        token=SilverToken(self,count)
        token.location = (-0.6, -3.5)
        self.objects.append(token) 
        count+1
