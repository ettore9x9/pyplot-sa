...
class SunnySideUpArena(Arena):
	...
	for i in range(38):
        ...
        token.location = (-7.8, 3.7)
        self.objects.append(token) 
        count+1
        
        token=SilverToken(self,count)
        token.location = (-6.7, 3.8)
        self.objects.append(token) 
        count+1
        
        token=SilverToken(self,count)
        token.location = (-2.5, 2.3)
        self.objects.append(token) 
        count+1
        
        token=SilverToken(self,count)
        token.location = (0, -0.3)
        self.objects.append(token) 
        count+1
        
        token=SilverToken(self,count)
        token.location = (4.3, 3.9)
        self.objects.append(token) 
        count+1
        
        token=SilverToken(self,count)
        token.location = (7.5, -1.4)
        self.objects.append(token) 
        count+1
        
        token=SilverToken(self,count)
        token.location = (-1.4, -3.7)
        self.objects.append(token) 
        count+1
