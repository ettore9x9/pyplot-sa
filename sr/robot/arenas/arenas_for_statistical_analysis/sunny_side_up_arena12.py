...
class SunnySideUpArena(Arena):
	...
	for i in range(38):
        ...
        token.location = (-8, -2.7)
        self.objects.append(token) 
        count+1
        
        token=SilverToken(self,count)
        token.location = (-6.2, 4.2)
        self.objects.append(token) 
        count+1
        
        token=SilverToken(self,count)
        token.location = (-2.8, 2.1)
        self.objects.append(token) 
        count+1
        
        token=SilverToken(self,count)
        token.location = (-0.3, -0.7)
        self.objects.append(token) 
        count+1
        
        token=SilverToken(self,count)
        token.location = (3.7, 4.2)
        self.objects.append(token) 
        count+1
        
        token=SilverToken(self,count)
        token.location = (8.1, 0.3)
        self.objects.append(token) 
        count+1
        
        token=SilverToken(self,count)
        token.location = (4, -4.2)
        self.objects.append(token) 
        count+1
